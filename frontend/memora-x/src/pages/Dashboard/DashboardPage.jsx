...
import {FileText, BookOpen, BrainCircuit, TrendingUp, Clock, DiamondPercentIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* {Stats Grid} */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 nb-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            {dashboardData.recentActivity && dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0 ? (
              <div className="space-y-3">
                {[
                  ...(dashboardData.recentActivity.dashboard.documents || []).map(doc => ({
                    id: doc._id,
                ...
                .sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp)).map((activity, index) => (
                  <div
                    ...
                    className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/5 border border-slate-200/60 hover:bg-white hover:shadow-slate-300/60 hover:shadow-md transition-all duration-200"
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <div className={`w-9 h-2 rounded-full ${activity.type === 'document' ? 'bg-linear-to-r from-blue-400 to-cyan-500' : 'bg-linear-to-r from-emerald-400 to-teal-500'
                            }`} />
