...
const QuizTakePage = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <p className="text-slate-600 text-lg">No questions found</p>
        </div>
      </div>
      );
  }
  ...
  return (
   <div className="max-w-4xl mx-auto">
    ...
    {/* {Progress Bar} */}
    <div className="mb-6">
     <div className="flex items-center justify-between nb-2">
    ...
    {/* {Question Card} */}
     <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8">
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl mb-6">
       <div className="w-2 h-2 bg-emerald-500 rounded-full animated-pulse">
        <span className="text-sm font-semibold text-emerald-700">Question {currentQuestionIndex + 1}
        </span>
       </div>
       ...
       <div className="space-y-3">
        {currentQuestion.options.map((option, index) => (
         ...
         <label
          ...
          isSelected
          ? 'border-emerald-500 bg-emerald-50 shadow-lg shadow-emerald-50/10'
   ...
   <div className="flex items-center justify-between gap-4">
    <Button
      ...
      variant='secondary'
      >
     <ChevronLeft className="w-4 h-4 group-hover:-translate-x-0.5 transition-tranform duration-200" strokeWidth={2.5} />
     Previous
    </Button>
    ...
    <button
     ...
     disabled={submitting}
     className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 disabled:cursor-not-allowed disabled:active:scale-100 overflow-hidden"
     >
      <span className="relative z-10 flex items-center justify-center gap-2">
        ...
        <Button
         ...
         >
         Next
         <ChevronRight className="w-4 h-4 group-hover:translate-x-o.5 transition-transform duration-200" strokeWidth={2.5} />
        </Button>
     )}
   </div>
