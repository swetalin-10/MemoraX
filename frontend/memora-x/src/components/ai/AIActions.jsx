...
import { Sparkles, BookOpen, LightBulb, Lightbulb } from "lucide-react";
...
const AIActions = () => {
    ...
    const handleExplainConcept = async (e) => {
        ...
        setLoadingAction("explainConcept");
        try {
        ...
        <div className="px-6 py-5 border-b border-slate-200/60 bg-linear-to-br from-slate-50/50 to-white/50 ">
          <div className="flex items-center gap-3">
           <div className="w-10 h-10 rounded-xl bg-linear-to-br from-emerald-500 to-emerald-600 shadow-lg shadow-purple-500/25 flex items-center justify-center">
            ...
            <div>
              <h3 className="test-lg font-semibold text-slate-900">
                AI Assistant
              </h3>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-8 h-8 rounded-lg bg-linear-to-br from-blue-100 to-cyan-100 flex items-centre justify-centre">
                ...
                <button
                  ...
                  className="hrink-0 h-10 px-5 bg-linear-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                >
            ...
            <form onSubmit ={handleExplainConcept}>
                <div className="flex items-centre gap-2 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-linear-to-br from-amber-100 to-orange-100 flex items-center justify-center">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed mb-4">Explain a concept from the document to get a detailed explanation</p>
                    <div className="flex items-center gap-3">
                      <input
                        type="text"
                        value={concept}
