...
import { BookOpen, Sparkle, TrendingUp } from 'lucide-react';
...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  const handleStudyNow = () => {
    ...
    const progressPercentage = totalCards > 0 ? Math.round((reviewedCount / totalCount) * 100) : 0;
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
                <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from emerald-100 to-teal-100 flex items-center justify-center">
                    <BookOpen className="w-6 h-6 text-emerald-900" strokewidth={2} />
                </div>
